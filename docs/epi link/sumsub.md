...
| amlCaseApproved                                                                            | Sent when an AML case review is completed and the result is approved (GREEN). Indicates that no significant AML-related issues were found for the transaction participant.                                                            |
