...
| [applicantKytTxnApproved](transaction-monitoring-webhooks#applicantkyttxnapproved)         | Transaction was approved, and the transfer or deposition of assets/properties can be expected soon.<br />changes                                                                                                                      |
| [applicantKytTxnRejected](transaction-monitoring-webhooks#applicantkyttxnrejected)         | Checks have been completed, and the review result is — **rejected**. changes                                                                                                                                                          |
